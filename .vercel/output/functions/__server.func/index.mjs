...
import { g as NodeResponse, n as HTTPError, s as defineLazyEventHandler, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_r1kgYX = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_r1kgYX
	};
	return ((_m, p) => {
		return {
			data,
